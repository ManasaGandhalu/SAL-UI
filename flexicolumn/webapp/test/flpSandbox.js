		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Flexi Column",
									"targetURL": "#comsapflexicolumn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapflexicolumn-display": {
								"semanticObject": "comsapflexicolumn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.flexicolumn",
									"url": sap.ui.require.toUrl("com/sap/flexicolumn")
								}
							}
						}
					}
